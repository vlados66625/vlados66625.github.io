...
var _sizeVideo = require("./modules/size-video");
var _activeInfoTrainer = require("./modules/active-info-trainer");
var _workingFields = require("./utils/working-fields");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _playButton.addEvtVideo)();
  (0, _sizeVideo.calculateVideoSize)();
  ...
  window.addEventListener('load', function () {
    (0, _workingFields.addWorkingFields)();
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _activeInfoTrainer.activeInfoTrainer)();
  });
});
...
},{"./modules/active-info-trainer":2,"./modules/form-validate/form":4,"./modules/play-button":10,"./modules/size-video":11,"./utils/ios-vh-fix":13,"./utils/working-fields":14}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.activeInfoTrainer = void 0;
var trainerPhotoContainer = document.querySelector('.trainer__swiper');
var activeInfoTrainer = function activeInfoTrainer() {
  if (trainerPhotoContainer && window.innerWidth < 1200) {
    trainerPhotoContainer.addEventListener('click', function (event) {
      var clickedTrainerPhoto = event.target.closest('.trainer__photo-container');
...
exports.activeInfoTrainer = activeInfoTrainer;
...
exports.calculateVideoSize = void 0;
var videoContainer = document.querySelector('.video-container');
var calculateVideoSize = function calculateVideoSize() {
  if (videoContainer) {
    var width = getComputedStyle(videoContainer).width;
    if (window.innerWidth >= 768) {
      var height = parseFloat(width) * 0.6278;
      videoContainer.style.height = height + 'px';
    }
    if (window.innerWidth >= 320 && window.innerWidth < 768) {
      var _height = parseFloat(width) * 0.5219;
      videoContainer.style.height = _height + 'px';
    }
  }
};
...
exports.addWorkingFields = void 0;
var addWorkingFields = function addWorkingFields() {
...
exports.addWorkingFields = addWorkingFields;
